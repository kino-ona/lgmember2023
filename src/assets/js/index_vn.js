$(document).ready(function () {
  ...
  // visual text rolling
  $(".lgmembersweek .visual .visual__rolling").on('init', (event, slick) => {
    var firstItem = slick.$slides[0];
    var firstItemWidth = $(firstItem).width();
    $(slick.$slideTrack).attr('style', `width: ${firstItemWidth}px !important`);
  });
  ...
  $(".lgmembersweek .visual .visual__rolling").on('beforeChange', (event, slick, currentSlide, nextSlide) => {
