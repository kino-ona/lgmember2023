$(document).ready(function () {
  ...
  $(".contents-template").each(function () {
    let [listName, tmp] = [
      $(this).closest(".section").data("list"),
      $(this).clone(),
    ];
    ...
    createProductItem: function (
      ...
      for (let i = 0; i < productList.length; i++) {
        ...
        let $productTag = $template.find(".product__flag"),
					$productTag0 = $template.find(".product__flag2"),
