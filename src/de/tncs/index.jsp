...
<body>
	...
	<style>
		.lgmembersdays-terms__wrap {max-width: 1440px;margin:40px auto 60px;padding:0 20px;}
		.lgmembersdays-terms__wrap h3 {
			font-size: 30px;
			font-weight: 700;
			margin-bottom: 30px;
		}
		.lgmembersdays-terms__wrap .list {
			margin-bottom: 30px;
		}
		.lgmembersdays-terms__wrap .list li {
			font-size: 20px;
			margin-bottom: 10px;
		}
		.lgmembersdays-terms__wrap .sub-title {
			font-weight: 700;
			font-size: 22px;
			margin-bottom: 10px;
		}
		@media screen and (max-width: 1024px) {
			.lgmembersdays-terms__wrap h3 {font-size:22px;}
			.lgmembersdays-terms__wrap .list li {font-size: 14px;}
			.lgmembersdays-terms__wrap .sub-title {font-size: 20px;}
		}
	</style>
	...
	<div class="wrapper">
      ...
      <div class="lgmembersdays-terms">
        <div class="lgmembersdays-terms__wrap">
          ...
          <ul class="list">
						<li>
							Der LG Member Days 10% Rabatt kann nur auf den Kauf von zwei oder mehreren LG Produkten angewendet werden, die auf https://www.lg.com/de/memberdays23H2 verfügbar sind. Beachte: Hot Deals Modelle sind von dem Rabatt ausgeschlossen.
						</li>
					</ul>
					<ul class="list">
						<li>
