...
<head>
	...
	<title>LG MEMBER DAYS: Big Savings Only For Members | LG France</title>
	<meta name="keywords" content="">
	<meta name="description" content="Take a chance on limited time & stock offer with member exclusive benefits. Hurry, offer ends on 00th October!">
	...
	<meta property="og:title" content="LG MEMBER DAYS: Big Savings Only For Members | LG France">
	<meta property="og:description" content="Take a chance on limited time & stock offer with member exclusive benefits. Hurry, offer ends on 00th October!">
...
<body>
	...
	<div class="sr-only" itemscope itemtype="http://schema.org/WebPage">
		<meta itemprop="name" content="LG MEMBER DAYS: Big Savings Only For Members | LG France"/>
		<meta itemprop="image" content="https://www.lg.com/lg5-common-gp/images/common/share/share-default.jpg" />
		<meta itemprop="url" content="https://www.lg.com/fr/lgmemberdays" />
		<meta itemprop="description" content="Take a chance on limited time & stock offer with member exclusive benefits. Hurry, offer ends on 00th October!" />
   ...
   <!-- // breadcrumb -->
	...
	<div class="wrapper">
		...
		<div class="lgmembersdays" data-locale="fr" data-action-url="/${localeCd}/mkt/ajax/nbaa/retrieveManualProductList">
			...
			<div class="visual">
				<div class="visual__visual">
					<div class="visual__inner">
						...
						<p class="desc">Get up to 00% for hot deal and choose your own bundle for extra discount<br>Sep 15th 2023 - Oct 5th 2023</p>
						<div class="term">
							<a href="#">
								Terms & Conditions
								<i></i>
			...
			<div class="main">
				<div class="section section--notborder">
					<div class="section__inner">
						<div class="section__header">
							<div class="section__group">
								<p class="title">Reveal the deals</p>
								<p class="desc">Sign in/up and enjoy limited time and stock offers</p>
							</div>
							<div class="button">
								<div class="button__row">
									<a href="https://www.lg.com/fr/my-lg" role="button" class="button__item button__item--secondary">Sign in</a>
									<a href="https://www.lg.com/fr/my-lg" role="button" class="button__item">Join us</a>
								</div>
							</div>
						</div>
						<div class="list-item">
							<div class="list-item__row">
								<div class="list-item__item">
									...
									<p class="desc">Unwrap special discounts for limited quantitiy on your favoirte LG products.</p>
								...
								<div class="list-item__item">
									...
									<p class="title">Even bigger bundles</p>
									<p class="desc">Save 15% on 2 products or 20% on 3 exclusive for LG members only</p>
									<a href="#sectionBuy" class="list-item__button"></a>
								</div>
								<div class="list-item__item">
									<div class="img">
										<img src="${path}/assets/images/img_deals03.png" alt="">
									</div>
									<p class="title">Additional 0% for members only</p>
									<p class="desc">Join now and get additonal benefits</p>
									<a href="#" class="list-item__button"></a>
								</div>
							</div>
						</div>
					</div>
				</div>
				<div class="section" id="sectionHotdeal" data-list="hotDeal">
					<div class="section__inner">
						<p class="title">Hot deals you can’t wait to unwrap</p>
						<p class="desc">Save up to 00% with limited offers on our selected products below</p>
						<div class="tab">
							<div class="tab__list">
								<a href="#homeappliance" role="button" class="tab__button tab__button--selected">Home Applianceo</a>
								<a href="#wireless" role="button" class="tab__button">Wireless-Earbuds</a>
								<a href="#computerproduct" role="button" class="tab__button">Computer Product</a>
							</div>
				...
				<div class="section" id="sectionBuy" data-list="hottest">
					<div class="section__inner">
						<p class="title">
							Unwrap the bundles<br>
							Extra discount will apply
						</p>
						<p class="desc">Buy 2 for 00%, 3 for 00%, extra discount coupons will be applied when checking out.</p>
						<div class="img">
									...
									<div class="product">
										...
										<div class="button">
											<div class="button__row">
												...
												data-link-area=""
												data-link-name=""
												class="button__item button__item--tertiary">SEE MORE TV</a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="section__inner">
						...
						<div class="banner">
							<div class="banner__banner">
								...
								<div class="button">
									<div class="button__row">
										<a href="#" class="button__item button__item--secondary">Learn more</a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="section">
					<div class="section__inner">
						<p class="title">Even more member benefits</p>
						<div class="benefit-more">
							<div class="benefit-more__row">
								<div class="benefit-more__item">
									<div class="benefit-more__group">
										<p class="title">Welcome Coupon</p>
										<p class="desc">Get 5% off your first purchase by joining</p>
									</div>
									<i class="benefit-more__ico"></i>
								</div>
								<div class="benefit-more__item">
									<div class="benefit-more__group">
										<p class="title">Exclusive Pricing</p>
								...
								<div class="benefit-more__item">
									<div class="benefit-more__group">
										...
										<p class="desc">On all orders purchased on LG.com</p>
									</div>
									<i class="benefit-more__ico"></i>
								</div>
							</div>
