...
<head>
	...
	<title>Ngày hội thành viên LG: Sản phẩm bán chạy nhất|Giảm thêm 20% | LG Việt Nam</title>
	<meta name="keywords" content="">
	<meta name="description" content="Giảm thêm 20% cho những sản phẩm bán chạy nhất. Ưu đãi đển hết 02.07.2023. Chỉ có tại LG.com/vn">
	<meta name="robots" content="NOODP, NOYDIR">
	<link rel="canonical" href="https://www.lg.com/vn/memberdays">
	<meta property="fb:app_id" content="">
	<meta property="og:locale" content="en_GB">
	<meta property="og:site_name" content="LG Việt Nam">
	<meta property="og:type" content="website">
	<meta property="og:title" content="Ngày hội thành viên LG: Sản phẩm bán chạy nhất|Giảm thêm 20% | LG Việt Nam">
	<meta property="og:description" content="Giảm thêm 20% cho những sản phẩm bán chạy nhất. Ưu đãi đển hết 02.07.2023. Chỉ có tại LG.com/vn">
	<meta property="og:url" content="https://www.lg.com/vn/memberdays">
...
<body>
	...
	<div class="sr-only" itemscope itemtype="http://schema.org/WebPage">
		<meta itemprop="name" content="Ngày hội thành viên LG: Sản phẩm bán chạy nhất|Giảm thêm 20% | LG Việt Nam"/>
		<meta itemprop="image" content="https://www.lg.com/lg5-common-gp/images/common/share/share-default.jpg" />
		<meta itemprop="url" content="https://www.lg.com/vn/memberdays" />
		<meta itemprop="description" content="Giảm thêm 20% cho những sản phẩm bán chạy nhất. Ưu đãi đển hết 02.07.2023. Chỉ có tại LG.com/vn" />
   ...
   <!-- // breadcrumb -->
		...
		<div class="lgmembersdays" data-locale="vn" data-action-url="/${localeCd}/mkt/ajax/nbaa/retrieveManualProductList">
				...
				<div class="visual__visual">
					<div class="visual__inner">
						...
						<div class="visual__bottom">
							...
							<div class="term">
								<a href="https://www.lg.com/vn/memberdays/tnc/index.jsp" target="_blank" role="button"
								data-track-group="MICROSITE" data-track-name="memberdays_mainbanner_click"
			...
			<div class="main">
				<div class="main__inner">
							...
							<div class="benefit__row">
								...
								<div class="button">
									...
									<div class="button__row">
										...
										data-link-area="memberdays_H2_Offer_click_MY ACCOUNT" 
										data-link-name="memberdays_2023H2" 
										class="button__item">TÀI KHOẢN CỦA TÔI</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="anchors" id="BestAirSolutions"></div>
									...
									<div class="best-item">
										<div class="best-item__row">
											<div class="best-item__item">
												...
												<p class="best-item__text">Tủ chăm sóc quần áo thông minh LG Styler</p>
											</div>
											<div class="best-item__item">
												<div class="best-item__img">
					...
					<div class="section">
						...
						<div class="term">
							<a href="https://www.lg.com/vn/memberdays/tnc/index.jsp" role="button" target="_blank"
							data-track-group="MICROSITE" data-track-name="Offer_link_click"
	...
	<script>
        ...
        $('#box_content .tab__list .tab__item').eq(1).addClass('tab__item--active');    
			...
			if(href.indexOf('BestAirSolutions') != -1) {    
				$('#box_content .tab__list .tab__panel').attr('display', 'none')
        $('#box_content .tab__list .tab__item').removeClass('tab__item--active');
